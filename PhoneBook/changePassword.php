...
<body bgcolor="#CCCCFF">
 ...
 <?php  include_once 'menu-main.php';?></div><br><br>
  ...
  <h1> <span style="color:black;">Change Password </span></h1>
  <table width="100%">
	  <tr>
		  <td><label><span style="color:black;">Old Password</span><span style="color:red">*</span></label> </td>
		  <td><input type="password" name ="oldpass" ></td>
	  </tr>
	  <tr>
		  <td><label><span style="color:black;">New Password</span><span style="color:red">*</span></label></td>
		  <td><input type="password" name="newpass" ></td>
	  </tr>
	  <tr>
		  <td><label><span style="color:black;">Confirm New Password</span><span style="color:red">*</span></label></td>
